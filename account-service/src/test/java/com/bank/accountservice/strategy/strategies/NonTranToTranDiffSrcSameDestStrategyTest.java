...
public class NonTranToTranDiffSrcSameDestStrategyTest {

    @Mock
    private BalanceService service;

    @InjectMocks
    private NonTranToTranDiffSrcSameDestStrategy nonTranToTranDiffSrcSameDestStrategy;
    ...
    public void testExecute_shouldSuccessfullyReverseBalanceAndMakeTransfer_whenValidAccountsAndAmount() {
        ...
        // When
        nonTranToTranDiffSrcSameDestStrategy.execute(oldAccountSourceNumber, newAccountSourceNumber,
