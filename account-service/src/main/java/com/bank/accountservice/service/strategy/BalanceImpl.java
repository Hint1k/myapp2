...
public class BalanceImpl implements Balance {
    ...
    @Autowired
    public BalanceImpl(AccountRepository accountRepository, TransactionEventPublisher publisher) {
    ...
    @Override
    public boolean isNullAccount(Account account, Long accountNumber, Long transactionId) {
