...
import com.bank.gatewayservice.service.AccessService;
...
public class FilterService extends OncePerRequestFilter {
    ...
    public FilterService(@Lazy UserService userService, AccessService accessService, JwtService jwtService,
